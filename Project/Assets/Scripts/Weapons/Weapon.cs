...
public abstract class Weapon : MonoBehaviour
{
    ...
    public Vector3 CrosshairToGunTarget(Camera camera, RectTransform crosshair)
    {
    ...
    {
        //YOU SHOULD CALL A FUNCTION HERE THAT DOES SOMETHING

    }
    public void DoHitReg(Transform bulletOriginPoint, Camera camera, RectTransform crosshair)
    {
        Vector3 gunTarget = CrosshairToGunTarget(camera, crosshair);
